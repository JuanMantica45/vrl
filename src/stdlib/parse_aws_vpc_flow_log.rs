...
fn inner_kind() -> BTreeMap<Field, Kind> {
    BTreeMap::from([
        ...
        (Field::from("protocol_ver"), Kind::bytes() | Kind::null()),
...
mod tests {
    ...
    test_function![
        ...
        protocol_ver {
             args: func_args![value: "5 52.95.128.179 10.0.0.71 80 34210 6 1616729292 1616729349 IPv4 14 15044 123456789012 vpc-abcdefab012345678 subnet-aaaaaaaa012345678 i-0c50d5961bcb2d47b eni-1235b8ca123456789 ap-southeast-2 apse2-az3 - - ACCEPT 19 52.95.128.179 10.0.0.71 S3 - - ingress OK",
                              format: "version pkt_srcaddr pkt_dstaddr dstport srcport protocol start end protocol_ver packets bytes account_id vpc_id subnet_id instance_id interface_id region az_id sublocation_type sublocation_id action tcp_flags srcaddr dstaddr pkt_src_aws_service pkt_dst_aws_service traffic_path flow_direction log_status"],
             want: Ok(value!({
